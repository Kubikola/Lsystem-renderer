...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionFern->setObjectName(QString::fromUtf8("actionFern"));
        actionKoch_s_snowflake = new QAction(MainWindow);
        actionKoch_s_snowflake->setObjectName(QString::fromUtf8("actionKoch_s_snowflake"));
        actionQuadratic_Koch_s_island = new QAction(MainWindow);
        actionQuadratic_Koch_s_island->setObjectName(QString::fromUtf8("actionQuadratic_Koch_s_island"));
        actionIslands_and_lakes = new QAction(MainWindow);
        actionIslands_and_lakes->setObjectName(QString::fromUtf8("actionIslands_and_lakes"));
        ...
        actionBroken_window->setObjectName(QString::fromUtf8("actionBroken_window"));
        actionLevy_C_curve = new QAction(MainWindow);
        actionLevy_C_curve->setObjectName(QString::fromUtf8("actionLevy_C_curve"));
        actionDragon_curve = new QAction(MainWindow);
        actionDragon_curve->setObjectName(QString::fromUtf8("actionDragon_curve"));
        ...
        actionCross_visibility->setObjectName(QString::fromUtf8("actionCross_visibility"));
        ...
        actionKoch_s_anti_snowflake->setObjectName(QString::fromUtf8("actionKoch_s_anti_snowflake"));
        actionGosper_s_curve = new QAction(MainWindow);
        actionGosper_s_curve->setObjectName(QString::fromUtf8("actionGosper_s_curve"));
        ...
        addColorChangeBtn->setObjectName(QString::fromUtf8("addColorChangeBtn"));
        ...
        startingLocationValLbl->setObjectName(QString::fromUtf8("startingLocationValLbl"));
        ...
        startingLocationLbl->setObjectName(QString::fromUtf8("startingLocationLbl"));

        gridLayout->addWidget(startingLocationLbl, 2, 2, 1, 1);

        lineLengthLbl = new QLabel(centralWidget);
        lineLengthLbl->setObjectName(QString::fromUtf8("lineLengthLbl"));
        ...
        rotationAngleSpinBox->setObjectName(QString::fromUtf8("rotationAngleSpinBox"));
        ...
        rotationAngleLbl->setObjectName(QString::fromUtf8("rotationAngleLbl"));
        ...
        axiomEdit->setObjectName(QString::fromUtf8("axiomEdit"));
        ...
        drawingDirectionLbl->setObjectName(QString::fromUtf8("drawingDirectionLbl"));
        ...
        generationLbl->setObjectName(QString::fromUtf8("generationLbl"));

        gridLayout->addWidget(generationLbl, 1, 2, 1, 1);

        axiomLbl = new QLabel(centralWidget);
        axiomLbl->setObjectName(QString::fromUtf8("axiomLbl"));
        ...
        generationSpinBox->setObjectName(QString::fromUtf8("generationSpinBox"));
        ...
        colorChangesGroupBox->setObjectName(QString::fromUtf8("colorChangesGroupBox"));
        ...
        colorChangesScrollArea->setObjectName(QString::fromUtf8("colorChangesScrollArea"));
        ...
        colorChangesScrollAreaContents->setObjectName(QString::fromUtf8("colorChangesScrollAreaContents"));
        ...
        drawingWidget->setStyleSheet(QString::fromUtf8("background-color: white"));

        gridLayout_2->addWidget(drawingWidget, 2, 0, 1, 4);

        rulesGroupBox = new QGroupBox(centralWidget);
        rulesGroupBox->setObjectName(QString::fromUtf8("rulesGroupBox"));
        ...
        rulesScrollAreaContents->setObjectName(QString::fromUtf8("rulesScrollAreaContents"));
