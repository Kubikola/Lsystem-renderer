...
public:
    ...
    void setupUi(QWidget *RuleForm)
    {
        if (RuleForm->objectName().isEmpty())
            RuleForm->setObjectName(QString::fromUtf8("RuleForm"));
        RuleForm->resize(662, 94);
        gridLayout = new QGridLayout(RuleForm);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        transcriptionRuleEdit = new QLineEdit(RuleForm);
        transcriptionRuleEdit->setObjectName(QString::fromUtf8("transcriptionRuleEdit"));
        ...
        arrowLbl->setObjectName(QString::fromUtf8("arrowLbl"));

        gridLayout->addWidget(arrowLbl, 1, 1, 1, 1);

        transcriptionRuleLbl = new QLabel(RuleForm);
        transcriptionRuleLbl->setObjectName(QString::fromUtf8("transcriptionRuleLbl"));
        ...
        letterLbl->setObjectName(QString::fromUtf8("letterLbl"));
