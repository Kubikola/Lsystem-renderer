...
public:
    ...
    void setupUi(QWidget *ColorChangeForm)
    {
        if (ColorChangeForm->objectName().isEmpty())
            ColorChangeForm->setObjectName(QStringLiteral("ColorChangeForm"));
        ...
        capitalLetterLbl->setObjectName(QStringLiteral("capitalLetterLbl"));
        ...
        removeColorChangeBtn->setObjectName(QStringLiteral("removeColorChangeBtn"));
        ...
        colorSelectBtn->setObjectName(QStringLiteral("colorSelectBtn"));
        ...
        capitalLetterEdit->setObjectName(QStringLiteral("capitalLetterEdit"));
