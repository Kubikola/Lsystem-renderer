/****************************************************************************
** Meta object code from reading C++ file 'drawingwidget.hpp'
**
...
#include "../../Lsystem/include/drawingwidget.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'drawingwidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 26), // "notifyCrossLocationChanged"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 22) // "crossVisibilityChanged"

    },
    "DrawingWidget\0notifyCrossLocationChanged\0"
    "\0crossVisibilityChanged"
};
...
void DrawingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->notifyCrossLocationChanged(); break;
        case 1: _t->crossVisibilityChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DrawingWidget::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawingWidget::notifyCrossLocationChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DrawingWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawingWidget.data,
      qt_meta_data_DrawingWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void DrawingWidget::notifyCrossLocationChanged()const
{
    QMetaObject::activate(const_cast< DrawingWidget *>(this), &staticMetaObject, 0, nullptr);
}
QT_WARNING_POP
